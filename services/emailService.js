 ...
 * @returns {{ user: string, pass: string, from: string }}
 */
...
/**
 * Generates branded StudyPulse AI HTML email template
 * @param {string} subject 
 * @param {string} messageContent 
 * @param {string} preformattedHtml 
 * @returns {string}
 */
 ...
 * @param {string} [params.html] - Optional pre-formatted HTML
